...
var setDate = function() {
    $('#py-alarm-start').val(moment({
        hour: 0,
        minute: 0,
        seconds: 0
    }).add(-1, 'days').format('YYYY-MM-DD HH:mm'));
    $('#py-alarm-end').val(moment({
        hour: 0,
        minute: 0,
        seconds: 0
...
var query = function() {
    ...
    var start = moment($('#py-alarm-start').val(), 'YYYY-MM-DD HH:mm').format('YYYY-MM-DD HH:mm:ss');
    var end = moment($('#py-alarm-end').val(), 'YYYY-MM-DD HH:mm').format('YYYY-MM-DD HH:mm:ss');
    var param = start + '&' + end;
    if (curnode !== null) {
        if (curnode.type === 0) {
