$().ready(function() {
    ...
    $('#login').click(login).blur(function(e) {
        $(this)
            .popover('close')
            .popover('destroy');
    });
...
var login = function() {
    ...
    if (isNullOrEmpty(password) === true) {
        $(this)
            ...
            .popover({
                theme: 'danger',
                content: '<i class="am-icon-times-circle py-icon"></i>解锁密码不能为空。'
            })
            .popover('open');
    ...
    if (isNullOrEmpty(key) === true) {
        $(this)
            ...
            .popover({
                theme: 'danger',
                content: '<i class="am-icon-times-circle py-icon"></i>获取令牌失败,请重试。'
            })
            .popover('open');
    ...
    if (atu === false) {
        $(this)
            ...
            .popover({
                theme: 'danger',
                content: '<i class="am-icon-times-circle py-icon"></i>密码错误,请重试。'
            })
            .popover('open');
